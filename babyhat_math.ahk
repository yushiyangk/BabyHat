...
*SC016:: putkey("u", "y", "Y",,, "each", "Each",,, "☕", "♨", "♎")
*SC017:: putkey("i", "d", "D", "ð", "Ð", "for", "For",,, "✓", "☑", "♏")
...
*SC021:: putkey("f", "o", "O", "œ", "Œ", "float", "Float", "̀",, "♣", "♧", "⊕")
*SC022:: putkey("g", "a", "A", "æ", "Æ", "double", "Double", "̈",, "☻", "☺", "♂")
*SC023:: putkey("h", "r", "R",,, "elsif", "Elsif",,, "♛", "♕", "♃")
*SC024:: putkey("j", "h", "H",,, "if", "If",,, "♟", "♙", "♄")
*SC025:: putkey("k", "t", "T", "þ", "Þ", "else", "Else",,, "♞", "♘", "⛢")
*SC026:: putkey("l", "g", "G",,, "then", "Then", "̂",, "♝", "♗", "♆")
...
*SC02F:: putkey("v", "f", "F",,, "new", "New",,, "⚖", "⚚", "△")
*SC030:: putkey("b", "k", "K",,, "function", "Function",,, "⚔", "☤", "☍")
